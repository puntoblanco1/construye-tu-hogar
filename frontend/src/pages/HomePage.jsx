...
import { ArrowRight, Users, Scale, TrendingUp, Home, Building2, CheckCircle, MapPin, ArrowUpRight } from 'lucide-react';
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1599995903128-531fc7fb694b?crop=entropy&cs=srgb&fm=jpg&q=85)',
          }}
        >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-32">
          <h1 className="text-5xl md:text-7xl font-bold text-[#d4a650] mb-6 animate-fade-in">
            {t.hero.title}
          </h1>
          <p className="text-xl md:text-2xl text-white mb-4 max-w-3xl mx-auto">
            {t.hero.subtitle}
          </p>
          <p className="text-base md:text-lg text-[#d4a650] mb-8 max-w-3xl mx-auto">
            {t.hero.description}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-[#0a1628]/60 backdrop-blur-md border border-gray-700 rounded-xl p-6 hover:border-[#d4a650] transition-all duration-300">
              <div className="text-4xl font-bold text-[#d4a650] mb-2">{t.hero.stat1}</div>
              <div className="text-gray-300">{t.hero.stat1Sub}</div>
            </div>
            <div className="bg-[#0a1628]/60 backdrop-blur-md border border-gray-700 rounded-xl p-6 hover:border-[#d4a650] transition-all duration-300">
              <div className="text-4xl font-bold text-[#d4a650] mb-2">{t.hero.stat2}</div>
              <div className="text-gray-300">{t.hero.stat2Sub}</div>
            </div>
            <div className="bg-[#0a1628]/60 backdrop-blur-md border border-gray-700 rounded-xl p-6 hover:border-[#d4a650] transition-all duration-300">
              <div className="text-4xl font-bold text-[#d4a650] mb-2">{t.hero.stat3}</div>
              <div className="text-gray-300">{t.hero.stat3Sub}</div>
            </div>
          </div>

          {/* Scroll indicator */}
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
            <div className="w-6 h-10 border-2 border-[#d4a650] rounded-full flex items-start justify-center p-2">
              <div className="w-1 h-3 bg-[#d4a650] rounded-full"></div>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-3">
                <Badge className="bg-green-500 text-white px-3 py-1">
                  {t.projects.card1.status}
                </Badge>
                <span className="text-sm text-gray-400">{t.projects.card1.model}</span>
              </div>
              
              <h3 className="text-3xl font-bold text-[#d4a650]">
                {t.projects.card1.title}
              </h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#0a1628]/60 backdrop-blur-sm border border-gray-700 rounded-lg p-4">
                  <Building2 className="w-8 h-8 text-[#d4a650] mb-2" />
                  <div className="text-2xl font-bold text-white">{t.projects.card1.stat1}</div>
                  <div className="text-sm text-gray-400">{t.projects.card1.stat1Label}</div>
                </div>
                <div className="bg-[#0a1628]/60 backdrop-blur-sm border border-gray-700 rounded-lg p-4">
                  <TrendingUp className="w-8 h-8 text-[#d4a650] mb-2" />
                  <div className="text-2xl font-bold text-white">{t.projects.card1.stat2}</div>
                  <div className="text-sm text-gray-400">{t.projects.card1.stat2Label}</div>
                </div>
                <div className="bg-[#0a1628]/60 backdrop-blur-sm border border-gray-700 rounded-lg p-4">
                  <MapPin className="w-8 h-8 text-[#d4a650] mb-2" />
                  <div className="text-base font-bold text-white">{t.projects.card1.stat3}</div>
                  <div className="text-sm text-gray-400">{t.projects.card1.stat3Label}</div>
                </div>
                <div className="bg-[#0a1628]/60 backdrop-blur-sm border border-gray-700 rounded-lg p-4">
                  <CheckCircle className="w-8 h-8 text-[#d4a650] mb-2" />
                  <div className="text-base font-bold text-white">{t.projects.card1.stat4}</div>
                  <div className="text-sm text-gray-400">{t.projects.card1.stat4Label}</div>
                </div>
              </div>

              <Button className="bg-[#d4a650] hover:bg-[#c49640] text-[#0a1628] font-semibold px-8 py-6 text-base rounded-lg transition-all duration-300 hover:shadow-xl flex items-center space-x-2">
                <span>{t.projects.card1.button}</span>
